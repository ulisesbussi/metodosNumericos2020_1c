...
\usecolortheme[RGB={74,91,120}]{structure}
...
%\setbeamercolor{title}{fg=black!90!blue,bg=SteelBlue!70}
\usefonttheme{professionalfonts}
\setbeamercovered{highly dynamic}
\setbeamercovered{transparent=10}
\setbeamertemplate{navigation symbols}{}
\colorlet{structure}{SteelBlue}
%\usecolortheme[RGB={205,173,0}]{structure}
\setbeamertemplate{frametitle}[default][left]
}

\definecolor{verzul}{rgb}{0, 0.5,0.5}
\renewcommand{\textbf}[1]{{\bfseries\textcolor{SteelBlue}{#1}}}
\renewcommand{\emph}[1]{{\em\textcolor{verzul}{#1}}}
...
%  \begin{minipage}{0.44\linewidth}
%    \begin{figure}[h]
%      \begin{center}        \includegraphics[width=1.2\linewidth]{Imgs/TrayectoriaGenerada_PresentacionRpic.pdf}  
%      \end{center}
%    \end{figure}
%  \end{minipage}
%
